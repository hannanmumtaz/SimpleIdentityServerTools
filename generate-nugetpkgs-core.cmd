...
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\Uma\SimpleIdentityServer.Uma.Common /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\Uma\SimpleIdentityServer.Uma.Core /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\Uma\SimpleIdentityServer.Uma.EF /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\Uma\SimpleIdentityServer.Uma.EF.InMemory /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\Uma\SimpleIdentityServer.Uma.EF.Postgre /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\Uma\SimpleIdentityServer.Uma.EF.Sqlite /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\Uma\SimpleIdentityServer.Uma.EF.SqlServer /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
...
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\SimpleIdServer\SimpleIdentityServer.Authenticate.SMS.Client /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\SimpleIdServer\SimpleIdentityServer.Authenticate.SMS.Common /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
...
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\SimpleIdServer\SimpleIdentityServer.Core.Jwt /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\SimpleIdServer\SimpleIdentityServer.EF /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\SimpleIdServer\SimpleIdentityServer.EF.InMemory /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
...
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\SimpleIdServer\SimpleIdentityServer.Store.InMemory /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\SimpleIdServer\SimpleIdentityServer.TwoFactorAuthentication /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\SimpleIdServer\SimpleIdentityServer.TwoFactorAuthentication.Email /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
...
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Apis\Scim\SimpleIdentityServer.Scim.Db.EF.InMemory /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
...
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Lib\WsFederation /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Lib\Serilog\Serilog.Sinks.ElasticSearch /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Lib\Serilog\Serilog.Sinks.RabbitMQ /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Lib\WebApiContrib\WebApiContrib.Core.Concurrency /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Lib\WebApiContrib\WebApiContrib.Core.Storage /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Lib\WebApiContrib\WebApiContrib.Core.Storage.InMemory /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Lib\WebApiContrib\WebApiContrib.Core.Storage.Redis /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Lib\Bus\SimpleBus.Core /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%
dotnet pack --output d:\sidfeeds\core\ IdServer\SimpleIdentityServer\src\Lib\Bus\SimpleBus.InMemory /p:PackageVersion=%packageVersion% /p:Version=%packageVersion%