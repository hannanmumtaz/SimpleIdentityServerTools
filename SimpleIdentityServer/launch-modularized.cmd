...
REM START cmd /k "bash ./wait-for-it.sh localhost:60000 -t 10000 && cd src/Apis/Module/SimpleIdentityServer.ScimProvider.Modularized.Startup && dotnet run -f net461"
...
REM START cmd /k "bash ./wait-for-it.sh localhost:60004 -t 10000 && cd src/Apis/Module/SimpleIdentityServer.EventStore.Modularized.Startup && dotnet run -f net461"
