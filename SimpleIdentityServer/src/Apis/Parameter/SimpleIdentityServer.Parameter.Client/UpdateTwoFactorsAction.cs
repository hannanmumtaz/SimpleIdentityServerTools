...
namespace SimpleIdentityServer.Parameter.Client
{
    ...
    {
        Task<ErrorResponse> Execute(string baseUrl, IEnumerable<UpdateTwoFactorRequest> parameters, string accessToken = null);
    }
    ...
    internal sealed class UpdateTwoFactorsAction : IUpdateTwoFactorsAction
    {
        ...
        public UpdateTwoFactorsAction(IHttpClientFactory httpClientFactory)
        {
            _httpClientFactory = httpClientFactory;
        }

        public async Task<ErrorResponse> Execute(string baseUrl, IEnumerable<UpdateTwoFactorRequest> parameters, string accessToken = null)
        {
