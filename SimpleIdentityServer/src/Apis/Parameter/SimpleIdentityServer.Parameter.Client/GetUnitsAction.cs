...
namespace SimpleIdentityServer.Parameter.Client
{
    ...
    {
        Task<GetUnitsResult> Execute(string baseUrl, string accessToken = null);
    }
    ...
    internal sealed class GetUnitsAction : IGetUnitsAction
    {
        ...
        public GetUnitsAction(IHttpClientFactory httpClientFactory)
        {
            _httpClientFactory = httpClientFactory;
        }

        public async Task<GetUnitsResult> Execute(string baseUrl, string accessToken = null)
        {
            ...
            return JsonConvert.DeserializeObject<GetUnitsResult>(json);
        }
    }
}