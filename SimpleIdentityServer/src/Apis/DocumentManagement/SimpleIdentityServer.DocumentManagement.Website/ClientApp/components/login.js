...
class Login extends Component {
    ...
    */
    externalAuthenticate() {
        ...
        var url = Constants.openidUrl + "/authorization?scope=openid role profile&state=75BCNvRlEGHpQRCT&redirect_uri="+Constants.adminuiUrl+"/callback&response_type=id_token token&client_id="+Constants.clientId+"&nonce=nonce&response_mode=query&amr_values=pwd";
